...
if (isset($_SESSION['valid_user'])) {
    ...
    echo 'Username:<br />';
    echo '<input id="username_input" class="login_input" name="username" type="text" placeholder="Enter your username" size="20px" width="3" /><br />';
    echo 'Password:<br />';
    echo '<input id="password_input" class="login_input" name="password" type="password" placeholder="Enter your password" size="20px" width="3" />';
    echo '<span class="errorMsgRed" hidden="hidden">Username and password cannot be empty</span></br>';
